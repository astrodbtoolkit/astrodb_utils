...
-------------------------
The **string_search** function allows you to search for objects that contain a specific string
...
-------------------------
The **query_region** function allows you to search for objects within a specified region.
